...
DOMAIN=connectifyvpn.me
echo $sub > /root/cfku
SUB_DOMAIN=${sub}.connectifyvpn.me
CF_ID=layankaki77@gmail.com
CF_KEY=ad6a6e0157a93fd0673963d89c85bc27295a4
echo ".connectifyvpn.me" > /root/domain
...
mkdir -p /var/lib/connectifyvpn
echo "IP=$SUB_DOMAIN" > /var/lib/connectifyvpn/ipvps.conf
echo $SUB_DOMAIN > /root/domain
...
<code>BY BOT : @ConnectifyVPNBot</code>
"
